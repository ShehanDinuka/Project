...
<body>
	...
	<form action="Register.php" method="post">
		...
		<p>
			...
			</div> <div class="col-md-4"> <input type="text" name="fname" id="fname" placeholder="Enter your first name"  class="form-control"><br></div> <div class="col-md-2 text-white" ><span><label for="" class="">Upload Your Image :*</label></div><div class="col-md-4"><input type ="file" class="btn btn-default btn-file" name="image" id="imgup" placeholder='Choose a file...' alt="Your Photo"></span><p>
			</div></div>
			<div class="row"><div class="col-md-2">
