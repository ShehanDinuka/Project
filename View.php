...
<?php
	...
	if($query_run=mysqli_query($db->getConnection(),$query)){
		...
		<label class='label'><input type='radio' name='{$results['reg_no']}'  value='accept'>	Accept		 "."<input type='radio' name='{$results['reg_no']}'  value='reject'>	Reject 		"."<input type='radio' name='{$results['reg_no']}'  value='keep'>	Keep </label>"
